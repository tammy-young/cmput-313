...
"""
Start up a Simple topology for CMPUT313
"""
...
class CMPUT313Controller( Controller ):
    "Controller for CMPUT313 Multiple IP Bridge"
...
def cmput313net():
    stophttp()
    "Create a simple network for cmput313"
    get_ip_setting()
    topo = CMPUT313Topo()
    info( '*** Creating network\n' )
    c0 = RemoteController(name='c0', ip='127.0.0.1', port=6633)
    net = Mininet( topo=topo, controller=c0, ipBase=IPBASE )
    net.start()
